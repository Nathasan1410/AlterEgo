            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                    <button
                        ...
                        className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                    >
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        {isRegeneratePage ? (
                            ...
                            <Card
                                variant="default"
                                className="p-8 cursor-pointer hover:border-orange-500 hover:shadow-xl transition-all group text-center"
                                onClick={onRegenerate}
                            >
                                <div className="flex flex-col items-center gap-4">
                                    <div className="w-16 h-16 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center">
                                        <RefreshCw className="w-8 h-8 text-orange-600 dark:text-orange-400 group-hover:rotate-180 transition-transform duration-500" />
                                    </div>
                                    <div>
                                        <p className="text-xl font-bold text-orange-600 dark:text-orange-400 mb-2">
                                            Regenerate Options
                                        </p>
                            ...
                            <Card
                                variant="default"
                                className="p-8 cursor-pointer hover:border-gray-500 hover:shadow-xl transition-all group text-center"
                                onClick={() => onSelect('')}
                            >
                                <div className="flex flex-col items-center gap-4">
                                    <div className="w-16 h-16 rounded-full bg-gray-100 dark:bg-gray-900/30 flex items-center justify-center">
